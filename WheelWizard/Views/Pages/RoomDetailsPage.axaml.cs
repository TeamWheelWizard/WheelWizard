...
public partial class RoomDetailsPage : UserControlBase, INotifyPropertyChanged, IRepeatedTaskListener
{
    ...
    private void ContextMenu_OnOpening(object? sender, CancelEventArgs e)
    {
        ...
        CopyMiiButton.IsEnabled = CanCopyMii(selectedPlayer);
    }

    private static bool CanCopyMii(RrPlayer player) => player.FirstMii?.CustomDataV1 is { IsWheelWizardMii: true, IsCopyable: true };
}
