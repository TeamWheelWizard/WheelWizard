...
public class GameLicenseSingletonService : RepeatedTaskManager, IGameLicenseSingletonService
{
    ...
    /// </summary>
    public LicenseProfile ActiveUser => Licenses.Users[_settingsManager.FocussedUser.Get()];

    public List<FriendProfile> ActiveCurrentFriends => Licenses.Users[_settingsManager.FocussedUser.Get()].Friends;
