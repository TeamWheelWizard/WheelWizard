...
public class MiiStudioDataSerializer
{
    ...
    private static byte[] GenerateStudioDataArray(byte[] buf)
    {
        ...
        // --- Basic Info ---
        var tmpU16_0 = BigEndianBinary.BufferToUint16(buf, 0);
        ...
        // --- Face ---
        var tmpU16_20 = BigEndianBinary.BufferToUint16(buf, 0x20);
        ...
        // --- Hair ---
        var tmpU16_22 = BigEndianBinary.BufferToUint16(buf, 0x22);
        ...
        // --- Eyebrows ---
        var tmpU32_24 = BigEndianBinary.BufferToUint32(buf, 0x24);
        ...
        // --- Eyes ---
        var tmpU32_28 = BigEndianBinary.BufferToUint32(buf, 0x28);
        ...
        // --- Nose ---
        var tmpU16_2C = BigEndianBinary.BufferToUint16(buf, 0x2C);
        ...
        // --- Mouth ---
        var tmpU16_2E = BigEndianBinary.BufferToUint16(buf, 0x2E);
        ...
        // --- Beard / Mustache ---
        var tmpU16_32 = BigEndianBinary.BufferToUint16(buf, 0x32);
        ...
        // --- Glasses ---
        var tmpU16_30 = BigEndianBinary.BufferToUint16(buf, 0x30);
        ...
        // --- Mole ---
        var tmpU16_34 = BigEndianBinary.BufferToUint16(buf, 0x34);
